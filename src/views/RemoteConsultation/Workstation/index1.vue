    ...
    <div>
        <div class="work__topCard-wr">
            <div class="work__topCard1">
                ...
                <span class="card-look-btn" @click="gotoRCAM2">查看</span>              
            </div>
            <div class="work__topCard2">
                ...
                <span class="card-look-btn" @click="gotoRCCM2">查看</span>   
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 跳转到申请管理：管理端
            gotoRCAM2() {
                this.$router.push({name : 'RCAM2', params : {'' : ''}});
            },
            // 跳转到会诊管理：管理端
            gotoRCCM2() {
                this.$router.push({name : 'RCCM2', params : {'' : ''}});
            },
            // 工作台数量统计
            qryMsgNum() {
                this.$ajax.post('',{
