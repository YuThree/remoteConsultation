						...
						<div class="y_chooseBtn">
							...
							<message-box :ref="'mes'+index" offsetLeft="-165px" offsetTop="-38px" width="156px" maxHeight="250px">
								<div class="y_ctrlBox">
									...
									<span class="qxsq" @click="$refs['mes'+index][0].show();modle('cancel',index)" v-show="getBtnIn('110003')&&i.IZT == 1">取消申请</span>
									<span class="bjxq" @click="$router.push({name:'EditApplication',params:{info:i}})" v-show="getBtnIn('110002')&&i.IZT == 1">编辑详情</span>
								</div>
							</message-box>
						</div>
